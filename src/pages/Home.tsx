        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center w-full">
          ...
          <div className="space-y-4 sm:space-y-6 text-center lg:text-left order-2 lg:order-1">
            ...
            <p className="fade-in-up delay-200 text-white/90 text-base sm:text-lg md:text-xl leading-relaxed max-w-xl mx-auto lg:mx-0">
              Domnerka are web applications that digitalize and streamline
              workprocesses and help ensure that tasks are completed in a
              timely, accurate, and organized manner. Execute processes, user
              completing tasks, filling out form, workflow and task delegation.
            </p>
          ...
          <div className="fade-in-up delay-600 relative order-1 lg:order-2">
            <div
              className="relative w-full aspect-square max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl mx-auto 
